...
<section class="heading">
    ...
    <p> <a href="home.php">Домой</a> / корзина </p>
</section>
...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="sub-total"> Итого : <span>$<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        ...
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">перейти к оформлению заказа</a>
    </div>
