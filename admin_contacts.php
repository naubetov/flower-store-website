...
<section class="messages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Эл. адрес : <span><?php echo $fetch_message['email']; ?></span> </p>
         <p>Сообщение : <span><?php echo $fetch_message['message']; ?></span> </p>
         <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">Удалить</a>
      </div>
      <?php
         }
      }else{
