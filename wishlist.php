...
<section class="heading">
    <h3>ваш список желаний</h3>
    <p> <a href="home.php">Домошняя страница</a> / список желаний </p>
</section>

<section class="wishlist">

    <h1 class="title">продукты добавлены</h1>
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">Ваш список пожеланий пуст</p>';
    }
    ?>
    </div>

    <div class="wishlist-total">
        <p>общий итог : <span>$<?php echo $grand_total; ?>/-</span></p>
        <a href="shop.php" class="option-btn">продолжить покупки</a>
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('удалить все из списка желаний?');">удалить все</a>
    </div>
