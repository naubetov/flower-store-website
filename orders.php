...
<section class="heading">
    <h3>Ваши заказы</h3>
    <p> <a href="home.php">Домой</a> / заказы </p>
</section>
...
<section class="placed-orders">
    ...
    ?>
    <div class="box">
        <p> Размещены на: <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
        ...
        <p> Тетод оплаты: <span><?php echo $fetch_orders['method']; ?></span> </p>
        ...
        <p> Статус платежа : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){echo 'tomato'; }else{echo 'green';} ?>"><?php echo $fetch_orders['payment_status']; ?></span> </p>
    </div>
    <?php
        }
    }else{
