...
<section class="heading">
    ...
    <p> <a href="home.php">Домошняя страница</a> / Поиск </p>
</section>

<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="поиск товара" name="search_box">
...
<section class="products" style="padding-top: 0;">
   ...
   <div class="box-container">
      ...
      <?php
                ...
                echo '<p class="empty">Результатов не найдено!</p>';
            }
        }else{
            echo '<p class="empty">можеть найдем</p>';
        }
      ?>
