...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="обновить название продукта" name="name">
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="обновить цену товара" name="price">
   ...
   <a href="admin_products.php" class="option-btn">Обратно</a>
</form>

<?php
      }
   }else{
      echo '<p class="empty">нет обновления выбора продукта</p>';
   }
?>
